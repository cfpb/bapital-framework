// Required modules.
const Events = require( 'bapital-atomic-component/src/mixins/Events.js' );
const BaseTransition = require( 'bapital-atomic-component/src/utilities/transition/BaseTransition' );
const contains = require( 'bapital-atomic-component/src/utilities/dom-class-list' ).contains;
