...
> NOTE: If you use `bapital-grid.less` directly,
...
**NOTE:** bapital-grid does not have a "row" concept.
If you have a 12-column grid and place 24 columns inside a wrapper,
bapital-grid columns will automatically stack into two rows of 12.
...
In bapital-grid, the way to get around this is by wrapping your columns
