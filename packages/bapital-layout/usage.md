...
> NOTE: If you use `bapital-layout.less` directly,
...
- [bapital-grid helpers](#bapital-grid-helpers)
...
## bapital-grid helpers

### .wrapper (base)

Turns an element into a bapital-grid wrapper at `801px` and above. Includes some
...
bapital-grid columns use left and right `border` for fixed `margin` which means it's
